                        ...
                        <div className="flex flex-col md:flex-row gap-5 ">
                          ...
                          <div className="md:w-1/2 lg:me-18 border rounded-lg  p-5 lg:px-14 border-gray-300">
                            <div className="flex  items-center md:justify-start mb-1 gap-4">
                              <h1 className="text-3xl">Dr. Timothy White</h1>
                              <MdVerified className="mt-2 text-blue-500 md:mt-1" />
                            </div>
                            <p className="mb-1">MBBS - Gynecologist

4 Year</p>
                            <p className="mb-1 font-medium">About:</p>
                            <p className="text-justify mb-1">
                            Dr. Timothy White has a strong commitment to delivering
                              comprehensive medical care, focusing on preventive medicine, early
                              diagnosis, and effective treatment strategies. Dr. Timothy White
                      ...
                      {/* ================================================= */}
                      <h1 className="text-center mt-5 md:mt-14 md:text-4xl font-medium">
                        Related Doctors
                      </h1>
                      ...
                      <div className="container mx-auto md:px-20 p-5">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 ">
                          {doctor
                            .filter((dd) => dd.role === "Gynecologist")
                            .map((dd, index) => (
                              <div
                                key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 ">
            <div className='md:ms-16 md:mt-14 flex  flex-col justify-start '>
              <div className=''>
