    ...
    <div>
        ...
        <div className="container mx-auto mt-5 md:mt-16 mb-10 rounded bg-blue-500">
            ...
            <div className="md:w-1/2  text-center md:text-start   md:ms-14  ">
             ...
             <button className='bg-white text-gray-400 mt-7 flex px-4 py-2 gap-2 rounded-3xl font-bold hover:scale-110 transition-all ease-linear mb-3 ' >Book appointment <span class="material-symbols-outlined ">
arrow_forward
</span> </button>
             </div>
